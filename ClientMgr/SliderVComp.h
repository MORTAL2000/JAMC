...
public:
	struct SliderVData {		
		...
		PComp * comp_label_bottom;
		PComp * comp_label_top;
		...
		void set_labels_visible( bool is_visible ) {
			is_label_visible = is_visible;
			comp_label_value->is_visible = is_visible;
			comp_label_title->is_visible = is_visible;
			comp_label_top->is_visible = is_visible;
		}
	};

	SliderVComp( Client & client );
	~SliderVComp( );
};
